...
export const pt: Translations = {
  ...
  sessions: {
    ...
    liveTail: "Atualização automática",
    liveTailFailed: "Falha na atualização automática",
    sessionList: "Lista de sessões",
    scrollToTop: "Voltar ao topo",
    scrollToBottom: "Ir para o mais recente",
    switchSession: "Trocar de sessão",
    transcript: "Transcrição",
    selectSessionPrompt: "Selecione uma sessão para ler a transcrição",
    newChat: "Novo chat",
    previousPage: "Página anterior",
    nextPage: "Página seguinte",
    toolResultLines: "{count} linhas",
    roles: {
      user: "Utilizador",
