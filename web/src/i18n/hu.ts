...
export const hu: Translations = {
  ...
  sessions: {
    ...
    sessionList: "Munkamenetlista",
    scrollToTop: "Vissza a tetejére",
    scrollToBottom: "Ugrás a legújabbra",
    switchSession: "Munkamenet váltása",
    transcript: "Átirat",
    selectSessionPrompt: "Válassz egy munkamenetet az átirat elolvasásához",
    newChat: "Új csevegés",
