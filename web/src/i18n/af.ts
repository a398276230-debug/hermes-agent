...
export const af: Translations = {
  ...
  sessions: {
    ...
    sessionList: "Sessielys",
    scrollToTop: "Terug na bo",
    scrollToBottom: "Gaan na die nuutste",
    switchSession: "Wissel sessie",
    transcript: "Transkripsie",
    selectSessionPrompt: "Kies 'n sessie om die transkripsie te lees",
    newChat: "Nuwe klets",
