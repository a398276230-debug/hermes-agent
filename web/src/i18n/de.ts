...
export const de: Translations = {
  ...
  sessions: {
    ...
    liveTail: "Automatisch aktualisieren",
    liveTailFailed: "Automatisches Aktualisieren fehlgeschlagen",
    sessionList: "Sitzungsliste",
    scrollToTop: "Nach oben",
    scrollToBottom: "Zum Neuesten springen",
    switchSession: "Sitzung wechseln",
    transcript: "Transkript",
    selectSessionPrompt: "Wähle eine Sitzung, um das Transkript zu lesen",
    newChat: "Neuer Chat",
    previousPage: "Vorherige Seite",
    nextPage: "Nächste Seite",
    toolResultLines: "{count} Zeilen",
    roles: {
      user: "Benutzer",
      assistant: "Assistent",
      system: "System",
