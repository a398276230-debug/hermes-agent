...
export const ga: Translations = {
  ...
  sessions: {
    ...
    sessionList: "Liosta seisiún",
    scrollToTop: "Fill ar barr",
    scrollToBottom: "Léim go dtí an ceann is déanaí",
    switchSession: "Athraigh seisiún",
    transcript: "Trascríbhinn",
    selectSessionPrompt: "Roghnaigh seisiún chun a thrascríbhinn a léamh",
    newChat: "Comhrá nua",
