...
export const es: Translations = {
  ...
  sessions: {
    ...
    liveTail: "Actualización automática",
    liveTailFailed: "Error en la actualización automática",
    sessionList: "Lista de sesiones",
    transcript: "Transcripción",
    selectSessionPrompt: "Selecciona una sesión para leer su transcripción",
    newChat: "Nuevo chat",
    previousPage: "Página anterior",
    nextPage: "Página siguiente",
    toolResultLines: "{count} líneas",
    roles: {
      user: "Usuario",
      assistant: "Asistente",
      system: "Sistema",
